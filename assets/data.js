...
const FSRS_DECK = [
  ...
  {
    id: 'card-henderson', ue: '3.1', concept: '14 besoins de Virginia Henderson',
    front: "Cite au moins 6 des 14 besoins fondamentaux selon Virginia Henderson.",
    back: "Respirer, boire/manger, éliminer, se mouvoir, dormir/se reposer, se vêtir, maintenir sa température, être propre, éviter les dangers, communiquer, agir selon ses croyances, s'occuper en vue de se réaliser, se récréer, apprendre.",
    md: '# 14 besoins (Henderson)\n## Physiologiques\n### Respirer\n### Boire et manger\n### Éliminer\n### Se mouvoir\n### Dormir\n### Se vêtir\n### Température\n### Être propre\n## Sécurité\n### Éviter les dangers\n## Sociaux\n### Communiquer\n### Croyances\n## Épanouissement\n### Se réaliser\n### Se récréer\n### Apprendre',
  },
  {
    id: 'card-dasri', ue: '2.10', concept: 'Tri des déchets (DASRI)',
    front: "Que signifie DASRI et où jette-t-on une aiguille usagée ?",
    back: "Déchets d'Activités de Soins à Risques Infectieux. Une aiguille va dans un collecteur d'objets piquants/coupants (OPCT) rigide et hermétique, jamais à la poubelle classique.",
    md: '# DASRI\n## Objets piquants/coupants\n### Collecteur OPCT rigide\n## Déchets mous contaminés\n### Sac jaune DASRI\n## Déchets non contaminés\n### Poubelle classique',
  },
  {
    id: 'card-consentement', ue: '1.3', concept: 'Consentement libre et éclairé',
    front: "Quelles sont les 3 conditions d'un consentement valide aux soins ?",
    back: "Libre (sans contrainte), éclairé (information claire et loyale préalable), et donné par une personne capable (majeure, apte à consentir).",
    md: '# Consentement\n## Libre\n### Sans contrainte\n## Éclairé\n### Information claire, loyale, appropriée\n## Capacité\n### Personne apte à consentir',
  },
  {
    id: 'card-escarre-stades', ue: '4.1', concept: "Stades de l'escarre",
    front: "Cite les 4 stades de l'escarre selon la classification usuelle.",
    back: "Stade 1 : rougeur ne blanchissant pas à la pression. Stade 2 : perte de substance superficielle (phlyctène, érosion). Stade 3 : perte de substance atteignant l'hypoderme. Stade 4 : atteinte des muscles/os/tendons.",
    md: "# Stades de l'escarre\n## Stade 1\n### Rougeur persistante\n## Stade 2\n### Phlyctène, érosion\n## Stade 3\n### Atteinte hypoderme\n## Stade 4\n### Atteinte muscle/os",
  },
  {
    id: 'card-constantes-adulte', ue: '2.2', concept: 'Constantes vitales normales (adulte)',
    front: "Cite les valeurs normales chez l'adulte : FC, FR, TA, température, SpO2.",
    back: "FC : 60-100/min. FR : 12-20/min. TA : ~120/80 mmHg. Température : 36,5-37,5°C. SpO2 : ≥95%.",
    md: '# Constantes vitales (adulte)\n## FC : 60-100/min\n## FR : 12-20/min\n## TA : ~120/80 mmHg\n## Température : 36,5-37,5°C\n## SpO2 : ≥95%',
  },
];
