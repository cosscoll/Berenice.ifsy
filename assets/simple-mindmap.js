  ...
  container.innerHTML = `
    <div class="mm-wrap" style="position:relative; border:1px solid var(--line); border-radius:12px; overflow:hidden; background:var(--mist);">
      ...
      <div class="mm-toolbar" style="position:absolute; top:8px; right:8px; display:flex; gap:4px;">
        <button type="button" class="mm-btn" data-action="zoom-in" title="Zoomer" aria-label="Zoomer">+</button>
        <button type="button" class="mm-btn" data-action="zoom-out" title="Dézoomer" aria-label="Dézoomer">−</button>
        <button type="button" class="mm-btn" data-action="reset" title="Réinitialiser la vue" aria-label="Réinitialiser la vue">⤾</button>
        <button type="button" class="mm-btn" data-action="fullscreen" title="Agrandir" aria-label="Agrandir en plein écran">⤢</button>
        <button type="button" class="mm-btn" data-action="download" title="Télécharger en SVG" aria-label="Télécharger la carte en SVG">⬇</button>
      </div>
    </div>
  `;
